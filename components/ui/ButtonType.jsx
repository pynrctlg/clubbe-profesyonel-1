        ...
        <>
            {
                ...
                buttonType === 'arrow' ?
                    <Link href={url} title={title} className={`${addClass ? addClass : ''} cta2`}>{children}<IoIosArrowRoundForward className='group-hover:translate-x-4 transition-all' /></Link>
                    :
                    buttonType === 'border' ?
                        ...
                        :
                        <Link href={url} title={title} className={`${addClass ? addClass : ''} cta`}> {children}</Link>
            }
        </>
    )
}